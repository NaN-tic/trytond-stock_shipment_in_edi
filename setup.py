...
MODULE = 'stock_shipment_in_edi'
PREFIX = 'nantic'
MODULE2PREFIX = {
    'edocument_unedifact': 'nantic',
    'stock_scanner': 'nantic',
...
dependency_links = [
    ...
    ('hg+https://bitbucket.org/nantic/'
        'trytond-stock_scanner@%(branch)s'
        '#egg=nantic-stock_scanner-%(series)s' % {
            'branch': branch,
            'series': series,
            }),
    ('hg+https://bitbucket.org/zikzakmedia/'
        'trytond-product_barcode@%(branch)s'
        '#egg=trytonzz-product_barcode-%(series)s' % {
            'branch': branch,
            'series': series,
            }),
    ('hg+https://bitbucket.org/nantic/'
